...
import { ResponseGetMockMessageDTO } from './mock-message.dto'
import { plainToInstance } from 'class-transformer';
import { validate, ValidationError } from 'class-validator';

export const validateMockMessageDTO = async (data: any) => {

    const responseDTO = plainToInstance(ResponseGetMockMessageDTO, data, { excludeExtraneousValues: true });
