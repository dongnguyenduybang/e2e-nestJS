...
import { ResponseGetUserByUsernameDTO } from './user-by-username.dto'
import { plainToInstance } from 'class-transformer';
import { validate, ValidationError } from 'class-validator';

export const validateGetUserByUsernameDTO = async (data: any) => {
    const responseDTO = plainToInstance(ResponseGetUserByUsernameDTO, data, { excludeExtraneousValues: true });
